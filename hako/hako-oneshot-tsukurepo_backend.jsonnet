...

{
  ...
  app: tsukurepo_backend.container(appCpu, appMemory) {
    image: std.format('%(account_id)s.dkr.ecr.ap-northeast-1.amazonaws.com/%(github_id)s-tsukurepo_backend', { account_id: provide('account_id'), github_id: github_id }),
  },
  scripts: [
    {
